...
$connection = mysqli_connect("localhost", "George", "Sunrise2017", "Sunrise"); 
	...
	$data_query="SELECT Name,Surname,People,ArrivalDate,DeprtureDate FROM Customer,Reservation WHERE ReservationID==$res_id";
	...
	echo "/head";
	echo "<body>";
	echo "<h2>Your Reservation's Informnation:</h2>";
	echo "<br><br>";
